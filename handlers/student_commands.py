...
from database.models import (
    add_user, get_user, update_user_group, 
    get_events, toggle_notifications, update_user_name,
    UserRole
)
from utils.decorators import admin_only, format_schedule_message
...
async def notifications_command(message: Message):
    ...
    notifications_enabled = user['notifications_enabled'] if isinstance(user, dict) else user[4]
